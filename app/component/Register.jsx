...
export default function Register() {
  ...
  async function Submit() {
    try {
      const IsCheckUserAccount = await CheckUserAccount(formData);
      console.log("hashPassword-----------" + IsCheckUserAccount.msg);
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-gray-900">
      {alert ? (
        <div className="absolute bg-black text-white top-0 h-20 px-5 py-5 uppercase">
          {alert}
        </div>
      ) : (
        ""
